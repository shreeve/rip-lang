...
const unminified = readFileSync('./www/dist/rip.browser.js');
console.log('✓ www/dist/rip.browser.js');
...
const minified = readFileSync('./www/dist/rip.browser.min.js');
const minSize = minified.length;
const minRatio = ((1 - minSize / unminified.length) * 100).toFixed(1);
console.log('✓ www/dist/rip.browser.min.js');
...
writeFileSync('./www/dist/rip.browser.min.js.br', compressed);

const brSize = compressed.length;
const brRatio = ((1 - brSize / minSize) * 100).toFixed(1);
console.log('✓ www/dist/rip.browser.min.js.br');
...
console.log('');
console.log('✨ Browser bundles ready in www/dist/');
