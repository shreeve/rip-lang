...
export const INTRINSIC_TYPE_DECLS = [
  ...
  // SVG presentation/geometry attributes are author-settable via setAttribute,
  // but the DOM reflects them as readonly `SVGAnimated*` IDL properties (so they
  // can carry both base + animated values). __RipAttrKeys filters readonly props
