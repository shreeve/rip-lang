...
| Query engine | None | None | Prisma Client | **ORM** (schema-driven — find, where, chain, relations, eager loading, hooks, soft-delete, factory, dirty tracking) |
...
- No query client matching Prisma Client's depth — ORM is functional (find, where, chain, relations, eager loading, lifecycle hooks, soft-delete, factory, dirty tracking, validation) but lacks transactions and middleware
